...
const VeryHeavyShowerRain = () => {
	return (
		<svg
			...
			<g filter="" id="rainy-7" transform='translate(6, -22) scale(2.6)'>
				...
				<g transform="translate(15,36), rotate(10)">
					...
					<line className="am-weather-rain-2" fill="none" stroke="#91C0F8" strokeDasharray="0.1,7" strokeLinecap="round" strokeWidth="3" transform="translate(10,-1)" x1="0" x2="0" y1="0" y2="8" />
				</g>
			</g>
		</svg>
	)
...
export default VeryHeavyShowerRain;