...
const VeryHeavyRain = () => {
	return (
		<svg
			...
			<g filter="" id="rainy-6" transform='translate(6, -20) scale(2.6)'>
				...
				<g transform="translate(15,36), rotate(10)">
					...
					<line className="am-weather-rain-2" fill="none" stroke="#91C0F8" strokeDasharray="4,4" strokeLinecap="round" strokeWidth="2" transform="translate(8,-1)" x1="0" x2="0" y1="0" y2="8" />
				</g>
			</g>
		</svg>
	)
